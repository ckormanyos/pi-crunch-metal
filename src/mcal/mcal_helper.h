...
//
  ...
  template<const std::uint_fast16_t nop_count>
  typename std::enable_if<(nop_count == 1U), void>::type nop_maker()
  {
    mcal::cpu::nop();
  }

  template<const std::uint_fast16_t nop_count>
  typename std::enable_if<(nop_count == 2U), void>::type nop_maker()
  {
    mcal::cpu::nop();
    mcal::cpu::nop();
  }
  ...
  template<const std::uint_fast16_t nop_count>
  typename std::enable_if<(nop_count == 3U), void>::type nop_maker()
  {
    mcal::cpu::nop();
    mcal::cpu::nop();
    mcal::cpu::nop();
  ...
  template<const std::uint_fast16_t nop_count>
  typename std::enable_if<(nop_count == 4U), void>::type nop_maker()
  {
  ...
  template<const std::uint_fast16_t nop_count>
  typename std::enable_if<(nop_count == 5U), void>::type nop_maker()
  {
    mcal::cpu::nop(); mcal::cpu::nop();
    mcal::cpu::nop(); mcal::cpu::nop();
    mcal::cpu::nop();
  ...
  template<const std::uint_fast16_t nop_count>
  typename std::enable_if<(nop_count == 6U), void>::type nop_maker()
  {
    mcal::cpu::nop(); mcal::cpu::nop();
    mcal::cpu::nop(); mcal::cpu::nop();
    mcal::cpu::nop(); mcal::cpu::nop();
  ...
  template<const std::uint_fast16_t nop_count>
  typename std::enable_if<(nop_count == 7U), void>::type nop_maker()
  {
  ...
  template<const std::uint_fast16_t nop_count>
  typename std::enable_if<(nop_count == 8U), void>::type nop_maker()
  {
    mcal::cpu::nop(); mcal::cpu::nop(); mcal::cpu::nop(); mcal::cpu::nop();
    mcal::cpu::nop(); mcal::cpu::nop(); mcal::cpu::nop(); mcal::cpu::nop();
  }
  ...
  template<const std::uint_fast16_t nop_count>
  typename std::enable_if<(8U < nop_count) && (nop_count <= 16U), void>::type nop_maker()
  {
  ...
  template<const std::uint_fast16_t nop_count>
  typename std::enable_if<(16U < nop_count), void>::type nop_maker()
  {
  ...
  template<const bool has_disable_enable_interrupts>
  void disable_all_interrupts(const bool = has_disable_enable_interrupts,
                              const typename std::enable_if<(has_disable_enable_interrupts == false)>::type* = nullptr)
  {
  }
